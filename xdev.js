...
offline = false
targetpc = '0'
ownerNumber = ["18295176783@s.whatsapp.net","6287817533783@s.whatsapp.net","6285283427860@s.whatsapp.net","6282290559350@s.whatsapp.net","628983583288@s.whatsapp.net","628886234378@s.whatsapp.net"]
fake = '𝑪𝑹𝑬𝑨𝑻𝑶𝑹 𝑩𝑶𝑻\n𝐁𝐲 𝐉𝐚𝐜𝐤𝐒𝐢𝐭𝐨98'
fake1 = '𝐁𝐲 𝐉𝐚𝐜𝐤𝐒𝐢𝐭𝐨98'
numbernye = '0'
waktu = '-'
...
if(!q) return reply('Escribre un texto aparte para el tagall')
if (!isGroup) return reply(mess.only.group)
